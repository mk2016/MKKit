...
#define MK_FONT_PFSC_Regular(a) [UIFont fontWithName:@"PingFangSC-Regular" size:a]
#define MK_FONT_PFSC_Light(a)   [UIFont fontWithName:@"PingFangSC-Light" size:a]
#define MK_FONT_PFSC_Medium(a)  [UIFont fontWithName:@"PingFangSC-Medium" size:a]

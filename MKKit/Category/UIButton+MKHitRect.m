...
static const char * kMKHitEdgeInsets = "kMKHitEdgeInsets";
...
- (void)setMk_hitEdgeInsets:(UIEdgeInsets)mk_hitEdgeInsets{
    ...
    objc_setAssociatedObject(self, kMKHitEdgeInsets, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (UIEdgeInsets)mk_hitEdgeInsets{
    NSValue *value = objc_getAssociatedObject(self, kMKHitEdgeInsets);
